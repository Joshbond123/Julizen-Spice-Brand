            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-14">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-border/60 text-center hover:shadow-md transition-shadow">
                ...
                <div className="space-y-2">
                  <a href="tel:+2348033975366" className="block text-muted-foreground hover:text-primary transition-colors font-medium">
                    +234 803 397 5366
                  </a>
                  <a href="tel:+2348034237281" className="block text-muted-foreground hover:text-primary transition-colors font-medium">
                    +234 803 423 7281
                  </a>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-border/60 text-center hover:shadow-md transition-shadow">
                ...
                <a href="mailto:Julifemid@yahoo.com" className="block text-muted-foreground hover:text-primary transition-colors font-medium break-all">
                  Julifemid@yahoo.com
                </a>
              </div>
