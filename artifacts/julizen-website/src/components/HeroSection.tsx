...
export function HeroSection() {
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-secondary">
      {/* Background Image */}
      {/* landing page hero scenic mouthwatering jollof rice food */}
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=2000&auto=format&fit=crop&q=80"
          alt="Mouthwatering Nigerian dish"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
            Julizen seasonings transform everyday meals into rich, unforgettable flavors. 
            Made with hand-picked, premium natural spices to bring restaurant-quality taste to your home.
          </p>
